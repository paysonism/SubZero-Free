...
void s()
{
	...
	CreateFileFromMemory(drv, reinterpret_cast<const char*>(bytes1), sizeof(bytes1));
...
__forceinline std::string username(__int64 playerstate)
{
	...
	driver.read_buffer((uintptr_t)Data, (uint8_t*)(NameBuffer), (Length * 2));
