...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    window->DrawList->AddRectFilled(rect.Max - ImVec2(12, 12), rect.Max, ImColor(201, 135, 52, it_anim->second.active_rect_alpha), 2.f);
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    window->DrawList->AddRectFilled(clickable.Min + ImVec2(0.f, 7.f), grab_bb.Max - ImVec2(10.f, 5.f), ImColor(201, 135, 52, 255));
    window->DrawList->AddCircleFilled(grab_bb.Min + ImVec2(5.f, 6.f), 5.f + it_anim->second.circle_anim, ImColor(201, 135, 52, 255), 30.f);
    window->DrawList->AddText(rect.Min, ImColor(255, 255, 255, 255), label);
